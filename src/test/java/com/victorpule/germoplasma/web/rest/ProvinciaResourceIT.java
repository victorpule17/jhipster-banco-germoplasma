...
class ProvinciaResourceIT {
    ...
    public static Provincia createEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombreProvincia(DEFAULT_NOMBRE_PROVINCIA);
        return provincia;
    }
    ...
    public static Provincia createUpdatedEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombreProvincia(UPDATED_NOMBRE_PROVINCIA);
        return provincia;
    }
    ...
    void putExistingProvincia() throws Exception {
        ...
        updatedProvincia.nombreProvincia(UPDATED_NOMBRE_PROVINCIA);
