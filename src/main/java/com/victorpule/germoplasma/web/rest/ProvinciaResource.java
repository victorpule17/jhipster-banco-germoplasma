...
import com.victorpule.germoplasma.repository.ProvinciaRepository;
...
/**
 * REST controller for managing {@link com.victorpule.germoplasma.domain.Provincia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProvinciaResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/provincias/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<Provincia>> getAllProvincias(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
