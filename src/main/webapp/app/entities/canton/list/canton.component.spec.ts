...
describe('Canton Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'canton', component: CantonComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cantons?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cantonService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCantonIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCantonIdentifier).toHaveBeenCalledWith(entity);
