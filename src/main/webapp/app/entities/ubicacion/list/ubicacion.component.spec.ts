...
describe('Ubicacion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ubicacion', component: UbicacionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ubicacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ubicacionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUbicacionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUbicacionIdentifier).toHaveBeenCalledWith(entity);
