...
import { EntityArrayResponseType, UbicacionService } from '../service/ubicacion.service';
...
export class UbicacionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUbicacion): number => this.ubicacionService.getUbicacionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.ubicacions = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IUbicacion[] | null): IUbicacion[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.ubicacionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
