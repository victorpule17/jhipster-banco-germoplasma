...
describe('Ubicacion routing resolve service', () => {
  ...
  let resultUbicacion: IUbicacion | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultUbicacion).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IUbicacion>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
